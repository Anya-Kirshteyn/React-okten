...
import {usePostsByUserQuery} from "../queries/post/usePostsByUserQuery .ts";
...
export const ComplexPage=()=>{
    ...
    const {data:posts, isLoading:postsLoading, error:postsError}=usePostsByUserQuery(userIdNumber);
